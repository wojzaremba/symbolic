...
\begin{abstract} We present an approach based on attributive grammars
  ...
  of the naive approach. Moreover, our method can be considered a
...
\item apply optimization like subexpression elimination, and exploit distributive property of multiplication in order to decrees final computational time of $\mathbb{T}$. This step is optional, and it won't decrease computational complexity.
\end{itemize}
