...
\centering
\mbox{
  \subfigure[Computation time for $\sum AB$ using standard algorithm vs using inferred optimal algorithm.]{
      \includegraphics[width=0.55\linewidth]{img/ab.eps}
      \label{ab}
  }\quad
\subfigure[Comparison of approximations with various number of Taylor terms.]{
  \includegraphics[width=0.45\linewidth]{img/approximations.eps} 
