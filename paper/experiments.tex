...
multiplication). \rob{Maybe put something in about comparable
  complexity to 2nd order optimization: ``Although the expressions will be expensive to
evaluate for large models, this is the same complexity as 2nd order
optimization methods''. Problem is that it opens a whole can of worms
