...
expressions to find how to express target expression exactly. If an expression
...
We search for a linear combination of generated expressions, which is equal to the target expression. 
